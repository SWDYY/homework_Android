...
public class unChecked extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        table.showDataWithCheckBox(db.executeFind(belongToString+"_order","state","'待审核'","order")
    ...
    class changeState implements View.OnClickListener{
        ...
        public void onClick(View v) {
            table.selectCheckBox_checked(R.id.MyTableData,unChecked.this,"待付款",
                    4,db,belongToString+"_order");
            table.showDataWithCheckBox(db.executeFind(belongToString+"_order","state","'待审核'","order")
                    ,unChecked.this,name,R.id.MyTableData);
        }
    }
}
